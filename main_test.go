...
func TestTaskQueueDefault(t *testing.T) {
	if os.Getenv("TEMPORAL_TASK_QUEUE") == "" && TaskQueue() != "lesson-l2_workflows_vs_activities-tq" {
		t.Errorf("TaskQueue() default = %q, want lesson-l2_workflows_vs_activities-tq", TaskQueue())
	}
}
...
func TestIntegration(t *testing.T) {
	...
	// поведения урока «Workflow vs Activity».
}
